...
public class PackageSuffixTest extends AbstractProcessorTest {
    ...
    public void ProcessAll() throws IOException {
        ...
        assertTrue(new File("target/packageSuffix/com/mysema/querydsl/domain/querydsl/QAnimalTest_Animal.java").exists());
    }
    
    @Override
    protected Collection<String> getAPTOptions() {
        return Arrays.asList("-Aquerydsl.packageSuffix=.querydsl");
    }
