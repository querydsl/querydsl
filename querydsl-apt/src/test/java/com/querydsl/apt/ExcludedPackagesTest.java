...
public class ExcludedPackagesTest extends AbstractProcessorTest {
    ...
    public void Process() throws IOException {
        ...
        assertFalse(new File("target/excludedPackages/com/mysema/querydsl/domain/p1").exists());
        assertTrue(new File("target/excludedPackages/com/mysema/querydsl/domain/p2").exists());
    }
