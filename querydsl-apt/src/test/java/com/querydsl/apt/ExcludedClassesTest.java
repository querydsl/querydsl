...
public class ExcludedClassesTest extends AbstractProcessorTest {
    ...
    public void Process() throws IOException {
        ...
        assertFalse(new File("target/excludedClasses/com/mysema/querydsl/domain/QArrayTest_ArrayTestEntity.java").exists());
    }

    @Override
    protected Collection<String> getAPTOptions() {
        return Arrays.asList("-Aquerydsl.excludedClasses=ArrayTest.ArrayTestEntity");
    }
