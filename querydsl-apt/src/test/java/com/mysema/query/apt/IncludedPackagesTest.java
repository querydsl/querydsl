...
public class IncludedPackagesTest extends AbstractProcessorTest {
    ...
    public void Process() throws IOException {
        ...
        assertFalse(new File("target/includedPackages/com/mysema/query/domain/p1").exists());
        assertTrue(new File("target/includedPackages/com/mysema/query/domain/p2").exists());
    }

    @Override
    protected Collection<String> getAPTOptions() {
        return Arrays.asList("-Aquerydsl.includedPackages=com.mysema.query.domain.p2");
    }
