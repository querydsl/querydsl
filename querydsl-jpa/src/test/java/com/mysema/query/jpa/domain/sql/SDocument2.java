...
public class SDocument2 extends com.mysema.query.sql.RelationalPathBase<SDocument2> {
    ...
    public final com.mysema.query.sql.PrimaryKey<SDocument2> sql120219232323320 = createPrimaryKey(id);

    public SDocument2(String variable) {
        super(SDocument2.class, forVariable(variable), "APP", "DOCUMENT2_");
    }

    public SDocument2(Path<? extends SDocument2> entity) {
        super(entity.getType(), entity.getMetadata(), "APP", "DOCUMENT2_");
    }

    public SDocument2(PathMetadata<?> metadata) {
        super(SDocument2.class, metadata, "APP", "DOCUMENT2_");
    }
