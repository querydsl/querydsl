...
public class Grammar {
    ...
    public static <A extends Number & Comparable<A>> Expr.Comparable<A> add(Expr<A> left, A right) {
        return createNumber(Ops.ADD, left, createConstant(right));
    }
    
    public static <A extends Number & Comparable<A>> Expr.Comparable<A> add(Expr<A> left, Expr<A> right) {
        return createNumber(Ops.ADD, left, right);
    }

    public static <A extends Number & Comparable<A>> Expr.Comparable<A> div(Expr<A> left, A right) {
        return createNumber(Ops.DIV, left, createConstant(right));
    }
    
    public static <A extends Number & Comparable<A>> Expr.Comparable<A> div(Expr<A> left, Expr<A> right) {
    ...
    public static <A extends Number & Comparable<A>> Expr.Comparable<A> mult(Expr<A> left, A right) {
        return createNumber(Ops.MULT, left, createConstant(right));
    }
    
    public static <A extends Number & Comparable<A>> Expr.Comparable<A> mult(Expr<A> left, Expr<A> right) {
    ...
    public static <A extends Number & Comparable<A>> Expr.Comparable<A> sqrt(Expr<A> left) {
        return createNumber(Ops.SQRT, left);
    }
    
    public static <A extends Number & Comparable<A>> Expr.Comparable<A> sub(Expr<A> left, A right) {
        return createNumber(Ops.SUB, left, createConstant(right));
    }

    public static <A extends Number & Comparable<A>> Expr.Comparable<A> sub(Expr<A> left, Expr<A> right) {
