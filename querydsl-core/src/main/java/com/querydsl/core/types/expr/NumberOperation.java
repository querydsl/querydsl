...
public class NumberOperation<T extends Number & Comparable<?>>
    ...
    public static <D extends Number & Comparable<?>> NumberExpression<D> create(Class<? extends D> type, Operator op, Expression<?> one) {
        return new NumberOperation<D>(type, op, ImmutableList.<Expression<?>>of(one));
    }
    
    public static <D extends Number & Comparable<?>> NumberExpression<D> create(Class<? extends D> type, Operator op, Expression<?> one, Expression<?> two) {
        return new NumberOperation<D>(type, op, ImmutableList.of(one, two));
    }
    
    public static <D extends Number & Comparable<?>> NumberExpression<D> create(Class<? extends D> type, Operator op, Expression<?>... args) {
