...
import com.querydsl.lucene5.QueryElement;
...
public class QueryElementTest {
    ...
    @Ignore
    public void test() {
        QueryElement element = new QueryElement(new TermQuery(new Term("str",
                "text")));
        assertEquals("str:text", element.toString());
        // assertEquals(element.getQuery().hashCode(), element.hashCode());

        QueryElement element2 = new QueryElement(new TermQuery(new Term("str",
                "text")));
