...
public final class Types {
    ...
    public static final ClassType BIG_DECIMAL = new ClassType(TypeCategory.NUMERIC,
            BigDecimal.class);

    public static final ClassType BIG_INTEGER = new ClassType(TypeCategory.NUMERIC,
            BigInteger.class);
    ...
    public static final ClassType CHARACTER = new ClassType(TypeCategory.COMPARABLE,
            Character.class, char.class);

    public static final ClassType CHAR = new ClassType(TypeCategory.COMPARABLE, char.class);

    public static final ClassType COLLECTION = new ClassType(TypeCategory.COLLECTION,
    ...
    public static final ClassType ITERABLE = new ClassType(TypeCategory.SIMPLE, Iterable.class,
            OBJECT);
