...
public class FilteredJavaSerializerTest {
    ...
    @Test
    public void test8() {
        assertMatches1Expr("true && true", cat.name.eq(otherCat.name).and(
                otherCat.name.like("Bob5%")));
    }
    ...
    @Test
    public void test10() {
        assertMatches1Expr("true && true", cat.name.lower().eq(
                otherCat.name.lower()).and(otherCat.name.like("Bob5%")));
    }

    @Test
    public void test11() {
        assertMatches1Expr("true && true", otherCat.name.lower().eq(
                cat.name.lower()).and(otherCat.name.like("Bob5%")));
    }

    @Test
    public void test12() {
        assertMatches2Expr("true && otherCat.getName().equals(a1)", cat.name
                .eq("Bob").and(otherCat.name.eq("Kate")));
    }

    @Test
    public void test13() {
        assertMatches2Expr("true && otherCat.getName().equals(a2)", cat.name
                .lower().eq("Bob").and(otherCat.name.eq("Kate")));
    }
    ...
    @Test
    public void test15() {
        assertMatches1Expr("true && cat.getName().endsWith(a1)", otherCat.name
                .ne(cat.name).and(cat.name.like("%Kate5")));
    }
