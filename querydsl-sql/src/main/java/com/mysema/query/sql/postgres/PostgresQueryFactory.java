 ...
 *
 */
public class PostgresQueryFactory implements SQLQueryFactory<PostgresQuery, SQLSubQuery, SQLDeleteClause, SQLUpdateClause, SQLInsertClause, SQLMergeClause>{
    ...
    public PostgresQuery from(Expression<?> from) {
    ...
    public PostgresQuery query() {
        return new PostgresQuery(queryFactory.getConnection(), queryFactory.getConfiguration());
    }
