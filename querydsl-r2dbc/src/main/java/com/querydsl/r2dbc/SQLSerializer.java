...
public class SQLSerializer extends SerializerBase<SQLSerializer> {
    ...
    public void serializeInsert(QueryMetadata metadata, RelationalPath<?> entity, List<R2DBCInsertBatch> batches) {
        this.entity = entity;
        templates.serializeInsert(metadata, entity, batches, this);
    }

    protected void serializeForInsert(QueryMetadata metadata, RelationalPath<?> entity, List<R2DBCInsertBatch> batches) {
