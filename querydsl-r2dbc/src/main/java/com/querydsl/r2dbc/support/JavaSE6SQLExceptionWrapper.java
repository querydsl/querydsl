...
/**
 * A {@link R2DBCExceptionWrapper} that wraps the additional exception
 * information in a {@code WrappedSQLCauseException} and links it to the chain.
 *
 * @author Shredder121
 */
class JavaSE6SQLExceptionWrapper extends R2DBCExceptionWrapper {
    ...
    public RuntimeException wrap(Throwable exception) {
        ...
        Iterable<Throwable> linkedSQLExceptions = getLinkedSQLExceptions(sqlException);
        return new QueryException(
                new WrappedSQLCauseException(linkedSQLExceptions, sqlException));
    }
