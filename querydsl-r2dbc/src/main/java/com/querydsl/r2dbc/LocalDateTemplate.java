 ...
 * @author mc_fish
 */
public class LocalDateTemplate<T extends Comparable<?>> extends LocalDateExpression<T> implements TemplateExpression<T> {
    ...
    protected LocalDateTemplate(Class<? extends T> type, Template template, ImmutableList<?> args) {
