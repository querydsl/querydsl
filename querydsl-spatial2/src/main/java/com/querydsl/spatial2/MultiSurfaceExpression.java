 ...
 * @param <T>
 */
public abstract class MultiSurfaceExpression<T extends AbstractGeometryCollection> extends GeometryCollectionExpression<T> {

    private static final long serialVersionUID = -7242434428143573217L;
