 ...
 * @param <T>
 */
public abstract class GeometryCollectionExpression<T extends AbstractGeometryCollection> extends GeometryExpression<T> {

    private static final long serialVersionUID = -239430630783570396L;
